...
// Source: github.com/ozonmp/srv-verification-api/internal/app/sender (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 *model.VerificationEvent) error {
	m.ctrl.T.Helper()
